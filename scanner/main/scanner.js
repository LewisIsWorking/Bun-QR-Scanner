...
class e {
  ...
  static async createQrEngine(a) {
    ...
    a = () => Promise.resolve().then(() => (init_qr_scanner_worker_min(), exports_qr_scanner_worker_min)).then((c) => c.createWorker());
  ...
  _scanFrame() {
    !this._active || this.$video.paused || this.$video.ended || ("requestVideoFrameCallback" in this.$video ? this.$video.requestVideoFrameCallback.bind(this.$video) : requestAnimationFrame)(async () => {
      if (!(1 >= this.$video.readyState)) {
        var a = Date.now() - this._lastScanTimestamp, b = 1000 / this._maxScansPerSecond;
...
var videoElem = "";
var qrScanner = new qr_scanner_min_default(videoElem, (result) => console.log("decoded qr code:", result), {});
export {
  stopScanning,
  startScanning,
  sayHi
